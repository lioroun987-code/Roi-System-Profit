...
export default function ReconcilePage() {
  ...
  const [filter, setFilter]               = useState<'all' | 'issues' | 'match' | 'missing' | 'business' | 'personal' | 'totals' | 'cancelled'>('all')
...
<div class="page">
  ...
  <div class="no-print" style="text-align:center;margin-top:24px">
    <button onclick="window.print()" style="background:#1e3a5f;color:white;border:none;padding:12px 32px;border-radius:8px;font-size:15px;font-weight:700;cursor:pointer">
      ...
      // Save HTML → get token → open the share URL directly (URL is copyable from browser)
      ...
      if (saveRes.ok) {
        ...
        // Fallback: open raw HTML if save failed
